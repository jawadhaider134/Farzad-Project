...
export default function Contact() {
  ...
  return (
    <div className="bg-[#F8F3EB] text-gray-800">
      {/* Hidden image to detect when the hero image is loaded */}
      <img
        src={heroCarpet}
        alt=""
        className="hidden"
        ...
        <>
              ...
              <div className="bg-white p-10 rounded-3xl shadow-2xl">
                ...
                <div className="space-y-6">
                  {[1, 2, 3].map((item) => (
                    <div key={item}>
                      <div
                        className={`h-5 w-28 rounded mb-3 ${shimmer}`}
                      />
          ...
          <section className="pb-24 px-6">
            <div className="max-w-7xl mx-auto">
              <div
                className={`h-[450px] rounded-3xl ${shimmer}`}
              />
            </div>
          </section>
        </>
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              ...
              <div className="bg-white p-10 rounded-3xl shadow-2xl">
                ...
                <form className="space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#8B1E1E] text-white py-4 rounded-xl font-semibold text-lg hover:bg-[#6e1717] transition"
                  >
                    Send Message
                  </button>
                </form>
