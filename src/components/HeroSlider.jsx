...
export default function HeroSlider() {
  ...
  useEffect(() => {
    async function fetchSlides() {
      try {
        // Try to get cached slides (safe version)
        ...
        // ❌ REMOVED: Base64 conversion (this was the problem)
        const slidesData = data;

        // safe cache (ONLY JSON, not images)
  ...
  return (
    <div className="relative w-full h-[600px] overflow-hidden">
      {slides.map((slide, idx) => (
        ...
        >
          <div className="absolute inset-0 bg-black/55 flex flex-col justify-center items-center text-center text-white p-6">
            {slide.description && (
